...
#        output <<  "\n!!!!!#{$1} \n"
      ...
      when /\\item(.*)/
        ...
        if is_enumerate==1 then
          output << "# "+$1.chomp+"\n"
#          output << "\n"+item_number[is_enumerate].to_s+". "+$1.chomp+"\n"
#          item_number[is_enumerate]+=1
        elsif is_enumerate==2 then
          output << "# "+$1.chomp+"\n"
#          output << "\n"+roman_num[item_number[is_enumerate]]+". "+$1.chomp+"\n"
#          item_number[is_enumerate]+=1
        elsif is_enumerate==3 then
          output << "# "+$1.chomp+"\n"
#          output << "\n"+alpha_num[item_number[is_enumerate]].to_s+". "+$1.chomp+"\n"
#          item_number[is_enumerate]+=1
